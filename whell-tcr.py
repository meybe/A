...
cl = LINETCR.LINE()
cl.login(token="EnQdqHFBsKC5T0JGfSZc.urhgg3GOqzgCxjL1Of3b+a.vKi5B6i27Ga7uYADQ6RJb04FmbNSFi6G980PBSYrlQc=")

ks = LINETCR.LINE()
ks.login(token="Em8peMc3L3uHP7uGctle.S4WtVqL+jRRcXbjCT4FSJG.lsia4wR1HviY1wSRzPCDwyhcXnKqc9daqlI17TLtcJY=")
...
Bots = [mid,Amid]
administrator = ["u5111c61b782841919c5c9975a05dc1fc"]
admin = ["u5111c61b782841919c5c9975a05dc1fc"]
